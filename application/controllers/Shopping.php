...
class Shopping extends CI_Controller {
	...
	{	
		...
		$this->load->model('member/keranjang_model');
	...
	public function index()
	{
		...
		$data['judul'] = "Selamat Datang ".$this->session->userdata('nama_m');
		$data['alamat'] = "";
	...
	public function proses_order()
	{
		...
		$data_order = array('tanggal' => date('Y-m-d'),
					   		'pelanggan' => $this->input->post('username'));
		...
		$this->cart->destroy();
		$data['kategori'] = $this->keranjang_model->get_kategori_all();
		$data['antrian']= $this->keranjang_model->antrian();
		$this->load->view('themes/header',$data);
